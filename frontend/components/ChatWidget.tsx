...
export function ChatWidget() {
  ...
  return <Box sx={{ position: "fixed", right: { xs: 12, md: 28 }, bottom: { xs: "max(12px, env(safe-area-inset-bottom))", md: 28 }, zIndex: 1400 }}>
    {open && <Paper elevation={24} sx={{ position: { xs: "fixed", sm: "absolute" }, inset: { xs: 0, sm: "auto" }, right: { sm: 0 }, bottom: { sm: 76 }, width: { xs: "auto", sm: 410 }, height: { xs: "100dvh", sm: 590 }, maxHeight: { sm: "calc(100dvh - 110px)" }, borderRadius: { xs: 0, sm: 4 }, overflow: "hidden", display: "flex", flexDirection: "column", border: "1px solid rgba(124,108,255,.35)" }}>
